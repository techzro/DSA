...
void print3(int n)
{ // nTriangle Numerical right angle pyramid
    for (int i = 0; i <= n; i++)
    {
        for (int j = 1; j <= i; j++)
        {
...
void print4(int n)
{ // Numeical Pyramid with same no.s in a linex
    for (int i = 0; i <= n; i++)
    {
        for (int j = 1; j <= i; j++)
        {
...
void print8(int n)
{ // inverted equillateral nStarTriangle
    for (int i = 0; i < n; i++)
    {
        for (int j = 1; j <= i; j++)
        {
...
void print9(int n)
{ // equillateral and inverted equillateral nStarTriangle
    for (int i = 1; i <= n; i++)
    {
        for (int j = 1; j <= n - i; j++)
        {
...
void print10(int n)
{ // without initial gap equillateral and inverted equillateral nStarTriangle
    for (int i = 1; i <= n; i++)
    {
        for (int j = 0; j < (i); j++)
        {
